      ...
      <div className={styles.container}>
        <div className={styles.bannerContent}>
          <div className={styles.bannerTag}>
            ...
            <p>AIIMS Trained • Advanced Care</p>
          </div>
          <h2 className={styles.title}>
            From<span className={styles.span1}> AIIMS </span> to Berhampur —{" "}
            <span className={styles.span2}> Advanced Eye Care </span>You Can
            Trust
          </h2>
          <p className={styles.description}>
            Led by <span>Dr. Aswini Kumar Behera</span> (AIIMS New Delhi),
            Naitrika Eye Care delivers world-class cataract, glaucoma, laser,
            and pediatric ophthalmology treatments with compassion and
            precision.
          </p>
          <div className={styles.buttonGroup}>
            <Button
              name="Book Your Appointment Now"
              isbtn1={true}
              icon={"calendar"}
              bgcolor=" #2563eb"
            />
        ...
        <div className={`${styles.bannerImage} text-center`}>
          <img src="assets/bannerImage.webp" className="commonshadow" alt="" />
